pipeline {
  ...
  environment {
        ...
        GIT_REPOSITORY_URL = 'https://github.com/Jieun55/fast'
        GIT_CREDENTIONALS_ID = 'git_cre'
        
        GIT_EMAIL = 'ohje7530@naver.com'
        GIT_NAME = 'Jieun55'
        GIT_REPOSITORY_DEP = 'git@github.com:Jieun55/deployment.git'

        // AWS ECR 정보. 본인껄로 넣으세요!!
        AWS_ECR_CREDENTIAL_ID = 'aws_cre'
        AWS_ECR_URI = '973510907968.dkr.ecr.ap-northeast-2.amazonaws.com' // 레지스트리주소
